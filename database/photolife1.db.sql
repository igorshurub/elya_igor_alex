...
INSERT INTO "authorization" ("login","password","id","fullname") VALUES ('ivan','Qwerty123!',1,'Иваныч'),
 ('fedor','Asdfg123!',2,'Феодосиф');
INSERT INTO "calls" ("id","patient_name","doctor_name","date","address","symptoms","diagnosis","prescription","medecine_id") VALUES (1,'Шуруб И.С.','Иванов Иван','2022-02-02','Ул Кукушкина д 69 к2','Головная боль, температура','Грипп','Соблюдать домашний режим','Ингавирин'),
 (2,'Алексей Самсонов','Иванов Иван','2022-02-01','Ул Космонавтов д 43','Рвота','Отравление','Пить смекту','Смекта');
INSERT INTO "Medicine" ("id","name","descripriom","effects") VALUES (1,'Ингавирин','Ингавирин® снижает вирусную нагрузку, ускоряет элиминацию вирусов, сокращает продолжительность болезни, снижает риск развития осложнений. Механизм действия реализуется на уровне инфицированных клеток за счет активации факторов врожденного иммунитета, подавляемых вирусными белками','К основным противопоказаниям стоит отнести:
